            ...
            (set, get) => ({
                ...
                updateProfile: async (userId: string, data: Partial<Profile>) => {
                    try {
                        ...
                        if (data.stats) {
                            if (data.stats.totalLikes !== undefined) updateData.total_likes = String(data.stats.totalLikes);
                            if (data.stats.totalFollowers !== undefined) updateData.total_followers = String(data.stats.totalFollowers);
                            if (data.stats.averageRating !== undefined) updateData.average_rating = String(data.stats.averageRating);
                            if (data.stats.totalRatings !== undefined) updateData.total_ratings = String(data.stats.totalRatings);
                        }
