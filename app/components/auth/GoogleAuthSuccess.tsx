            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        // If session check failed, try getting account directly
                        if (!sessionValid) {
                            const accountData = await account.get();
                            if (accountData && accountData.$id) {
                                console.log('[GoogleAuthSuccess] Account found via account.get():', accountData.$id);
                                sessionValid = true;
                            }
                        }
                ...
                if (userContext && userContext.checkUser) {
                    ...
                    if (userData !== null && userData !== undefined) {
                        ...
                        if (!successShownRef.current) {
                            ...
                            toastIdRef.current = toast.success(`Welcome back, ${userName}!`, {
                                id: 'auth-success',
                                icon: '✅',
                                duration: 3000,
                            });
