...
export default function ResetPasswordForm() {
    ...
    useEffect(() => {
        ...
        if (!searchParams) {
            setError('Error getting URL parameters');
            return;
        }
        
        // Get parameters from URL that Appwrite provides
    ...
    const handleResetPassword = async () => {
        ...
        try {
            ...
            // Use Appwrite method to set new password
            await account.updateRecovery(userId, secret, password, password);
            
            // Show success notification
            toast.success('Password successfully changed! You can now log in with your new password.');
            
            // Mark that reset was completed successfully
