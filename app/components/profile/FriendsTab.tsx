...
import { BsPeople, BsPersonPlus, BsCheckLg, BsXLg, BsPersonDash, BsGlobe, BsClock, BsCalendar } from 'react-icons/bs';
import { FaUserFriends, FaUserClock, FaPaperPlane, FaSearch } from 'react-icons/fa';
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 backdrop-blur-md bg-[#1E2136]/70 p-4 border-t border-white/10">
                <h3 className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300 truncate mb-1">{user.name}</h3>
...
const EmptyState: React.FC<{ message: string, icon: React.ReactNode, actionButton?: React.ReactNode }> = ({ message, icon, actionButton }) => (
    <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
